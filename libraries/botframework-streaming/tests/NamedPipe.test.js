...
describe.windowsOnly('Streaming Extensions NamedPipe Library Tests', function () {
    ...
    describe('NamedPipe Client Tests', function () {
        ...
        it('sends without throwing', function (done) {
            ...
            const server = new NamedPipeServer('pipeA', new TestRequestHandler());
            const client = new NamedPipeClient('pipeA');
            const pingServer = () =>
                new Promise((resolve) => {
    ...
    describe('NamedPipe Server Tests', function () {
        ...
        it('sends without throwing', function (done) {
            ...
            const server = new NamedPipeServer('pipeA');
            const client = new NamedPipeClient('pipeA', new TestRequestHandler());
            const pingServer = () =>
                new Promise((resolve) => {
                    // Ping server before sending any information, so the server makes the connection over the socket.
                    client.send(new StreamingRequest());
