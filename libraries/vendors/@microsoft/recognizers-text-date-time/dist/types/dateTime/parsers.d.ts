import { IParser, ParseResult, ExtractResult } from "botbuilder-recognizers-text";
import { BaseNumberParser, BaseNumberExtractor } from "botbuilder-recognizers-text-number";
